# ClipSync - Cross-device Clipboard Real-time Sync

A lightweight, high-performance clipboard synchronization service written in Go. Optimized for 1GB VPS, featuring real-time WebSocket broadcasting, JWT authentication, and SQLite history storage.
